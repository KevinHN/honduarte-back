...
const registro_admin = async function(req, res) {
    ...
    if (admins_arr.length == 0) {
        ...
        res.status(200).send({message:'Correo ya existente en base de datos',data:undefined});
    }
    ...
    if(req.user){
        if (req.user.role == 'admin'){ 
          ...
          for(var item of reg){
            ...
            if(createdAt_date.getFullYear()== current_year){
                ...
                if (mes== current_month-1) {
                    tota_mes_anterior=tota_mes_anterior+item.subtotal
                }
            ...
            if (mes==1) {
                ...
                noviembre=febrero+item.subtotal;
            }
            else if(mes==12){
          ...
          res.status(200).send({
                ...
                tota_mes_anterior:tota_mes_anterior
          });
